    ...
    async onScanSuccess(decodedText) {
        ...
        try {
            ...
            if (dadosQr && dadosQr.id) {
                ...
                // (Isso Ã© arriscado se matrícula repetir em turmas diferentes, mas o scanner valida turmaId abaixo)
    ...
    async finalizarChamada() {
        ...
        if (presencasCount === 0) {
            const confirmarFinalizacao = await app.confirmarAcao({
                ...
                message: 'Nenhuma presenÃ§a foi registrada. Deseja finalizar mesmo assim?',
