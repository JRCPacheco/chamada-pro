...
const app = {
    ...
    criarCafeUiSeNecessario() {
        ...
        if (telaTurmas && !document.querySelector('.coffee-fab')) {
            ...
            btn.setAttribute('aria-label', 'Hora do Café');
            btn.setAttribute('title', 'Hora do Café');
            ...
            .then((registration) => {
                ...
                const avisarAtualizacao = async (worker) => {
                    if (typeof utils !== 'undefined' && typeof utils.mostrarToast === 'function') {
                        utils.mostrarToast('Nova versão disponível. Recarregue para atualizar.', 'info', 5000);
                    } else {
